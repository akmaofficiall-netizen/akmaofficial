...
export async function migrateDatabase() {
  ...
  await db.execute(sql`
    ...
    INSERT INTO permissions(code, name) VALUES
      ...
      ('customers.archive','آرشیو مشتری'),('orders.view','مشاهده سفارش'),('orders.create','ثبت سفارش'),
    ...
    INSERT INTO role_permissions(role_id, permission_id)
      SELECT r.id, p.id FROM roles r JOIN permissions p ON p.code IN ('customers.view','customers.create','customers.update','orders.view','orders.create','invoices.view','commissions.view','reports.view','projects.view','customers.transfer','payments.create') WHERE r.code='sales'
    ON CONFLICT DO NOTHING;
    INSERT INTO role_permissions(role_id, permission_id)
      SELECT r.id, p.id FROM roles r JOIN permissions p ON p.code IN ('customers.view','customers.create','customers.update','orders.view','orders.create','orders.update','orders.cancel','invoices.view','commissions.view','reports.view','cost.view','profit.view','projects.view','projects.update','customers.transfer','payments.create') WHERE r.code='manager'
    ON CONFLICT DO NOTHING;
